...
The output also confirms `SMB1 disabled`, showing that legacy SMB1 is not offered (covered further in [04-security-hardening.md](04-security-hardening.md)).
