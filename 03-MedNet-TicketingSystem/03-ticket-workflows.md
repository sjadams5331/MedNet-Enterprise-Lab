...
![Corrected state showing both Clinical Systems tickets at High priority](../screenshots/03-ticket-workflows_04.png)
...
| 108659, Clinical Applications Support | Submitted under wrong topic, escalated Help Desk to Clinical Systems | Closed, High priority, SLA corrected on second transfer |
...
- Severity and source host determine department and priority (a Zabbix trigger on network hardware routes to Network & Infrastructure; a Wazuh alert on a clinical host routes to Clinical Systems), so automated tickets inherit the same routing and SLA behavior validated manually above.
